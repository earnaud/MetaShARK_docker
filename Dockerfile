...
RUN apt-get update && apt-get install -y -f libcurl4-openssl-dev default-jre-headless git-core librasqal3-dev libjq-dev libpoppler-cpp-dev librdf0-dev libssh2-1-dev libssl-dev libv8-dev libxml2-dev make pandoc pandoc-citeproc zlib1g-dev && rm -rf /var/lib/apt/lists/*
